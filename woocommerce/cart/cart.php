...
?>
<div class="container pt-86 pt-md-56 pt-sm-46"><?php woocommerce_output_all_notices(); ?></div>
<?php
do_action( 'woocommerce_before_cart' ); ?>

<form class="woocommerce-cart-form pb-86 pb-md-56 pb-sm-46" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
				...
				<div class="col-lg-8">
					<div class="shopping-cart-list-area">
						<div class="shopping-cart-table table-responsive">
							...
							<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents table table-bordered text-center" cellspacing="0">
								<thead>
									<tr>
										...
										if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
											...
											<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
													...
													<div class="cart-product-item d-flex align-items-center">
														...
														<?php
															echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
																...
																sprintf(
																	'<div class="remove-icon"><a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s"><i class="fa fa-trash-o"></i></a></div>',
														...
														<?php
															if ( ! $product_permalink ) {
																...
																echo wp_kses_post( apply_filters( 'woocommerce_cart_item_name', sprintf( '<a href="%s" class="product-name" data-title="Product">%s</a>', esc_url( $product_permalink ), $_product->get_name() ), $cart_item, $cart_item_key ) );
															}
												...
												<td class="product-quantity" data-title="<?php esc_attr_e( 'Quantity', 'woocommerce' ); ?>">
													<div class="pro-qty cart-page__qty">
														<input type="number" class="quantity" value="<?php echo $cart_item['quantity']; ?>"/>
														<a href="#" class="inc qty-btn">+</a>
														<a href="#" class= "dec qty-btn">-</a>
													</div>
													<div class="product-quantity__old-input">
													<?php
